// studio/src/lib/toolCategories.js

export const TOOL_CATEGORIES = {
    // Client-side control flow (lib/controlTools.js), not bridge tools.
    ...
    'Rendering': ['configure_render_settings', 'render_frame', 'render_animation', 'generate_views'],
